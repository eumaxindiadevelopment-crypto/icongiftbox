...
const DEFAULT_SLIDE = { logoImage: '', animDuration: 0.6 }

const DEFAULT = {
  sectionTitle:  'Our Client',
  slides:        [],
  autoplay:      true,
  autoplayDelay: 3000,
}
  ...
  return (
    <div className="space-y-6 max-w-4xl">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-xl font-semibold text-gray-900">Our Client</h1>
          <p className="text-sm text-gray-500 mt-0.5">Manage the client logo carousel on the home page</p>
        </div>
        ...
        <div className="grid grid-cols-2 gap-3">
          <div>
            ...
            <input className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
              value={form.sectionTitle} onChange={e => set('sectionTitle', e.target.value)} placeholder="Our Client" />
          </div>
          <div>
