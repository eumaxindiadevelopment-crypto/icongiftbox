...
export default function ShopListCard(props: varibleType){
    ...
    const productHref = productLink
        ? buildProductUrl({ slug: props.slug, _id: props.id, primaryCategory: props.primaryCategory })
        : "/shop-list";
        ...
        <div className="dz-shop-card style-2">
            ...
            <div className="dz-content">
                <div className="dz-header">
                    <div>
                        <h4 className="title mb-0"><Link to={productHref}>{props.title}</Link></h4>
                ...
                <div className="dz-body">
                    ...
                    <div className="rate">
                        ...
                        <div className="d-flex">
                            <Link to="#" onClick={(e) => { e.preventDefault(); handleAddToCart(); }} className="btn btn-secondary btn-md btn-icon">
