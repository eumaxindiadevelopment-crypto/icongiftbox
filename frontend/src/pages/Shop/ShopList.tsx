...
export default function ShopList(){
    ...
    return(
        <div className="page-content bg-light">
            <CommanBanner mainText="Shop List" currentText="Shop List" parentText="Home" image={IMAGES.BackBg1}/>
                            ...
                            <div className="sticky-xl-top">
                                ...
                                <div className="shop-filter mt-xl-2 mt-0">
                                    <aside>   
                                        ...
                                        <ShopSidebar buildCategoryHref={(category) => category ? `/shop/category/${category.slug}` : "/shop-list"} />
                                ...
                                <div className="row">
                                    <Tab.Content className="col-12 tab-content shop-" id="pills-tabContent">
                                        <Tab.Pane eventKey={"List"}>
                                            <div className="row">
                                                {products.slice(0, 6).map((elem, ind)=>(
                                                    <div className="col-md-12 col-sm-12" key={ind}>
                                                        <div className="dz-shop-card style-2">
                                                            <div className="dz-media">
                                                                <img src={elem.image} alt="shop" />
                                                            </div>
                                                            <div className="dz-content">
                                                                <div className="dz-header">
                                                                    <div>
                                                                        <h4 className="title mb-0"><Link to="/shop-with-category">{elem.name}</Link></h4>
                                                                    ...
                                                                    <div className="review-num">
                                                                        ...
                                                                        <span><Link to="#"> 370 Review</Link></span>
                                                                    </div>
                                                                </div>
                                                                <div className="dz-body">
                                                                    ...
                                                                    <div className="rate">
                                                                        ...
                                                                        <div className="d-flex">
                                                                            <Link to="/cart" className="btn btn-secondary btn-md btn-icon">
                                            ...
                                            <div className="row gx-xl-4 g-3 mb-xl-0 mb-md-0 mb-3">
                                                {products.map((item, ind)=>(
                                                    <div className="col-6 col-xl-6 col-lg-6 col-md-6 col-sm-6 m-md-b15 m-sm-b0 m-b30" key={ind}>
                                                        <ShopGridCard id={(item as any)._id} slug={(item as any).slug} image={item.image} title={item.name} price={item.price}/>
                                                    </div>
                                                ))}
                                            </div>
                                        </Tab.Pane>                                                                                
