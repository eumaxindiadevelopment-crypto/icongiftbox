                                                ...
                                                <div className="col-lg-6 m-lg-b0 m-md-b30">
                                                    ...
                                                    <div className="product-media row g-xl-4 g-2 m-b40">
                                                        <div className="col-md-3 col-3 col-sm-3 product-media-inner">
                                                            <Link to="/shop-list" className="dz-media">
                                                                <img src={IMAGES.ProductDress1} alt="/" />
                                                            </Link>
                                                        </div>
                                                        <div className="col-md-3 col-3 col-sm-3 product-media-inner">
                                                            <Link to="/shop-list" className="dz-media">
                                                                <img src={IMAGES.ProductDress2} alt="/" />
                                                            </Link>
                                                        </div>
                                                        <div className="col-md-3 col-3 col-sm-3 product-media-inner">
                                                            <Link to={"/shop-list"} className="dz-media">
                                                                <img src={IMAGES.ProductDress3} alt="/" />
                                                            </Link>
                                                        </div>
                                                        <div className="col-md-3 col-3 col-sm-3 product-media-inner">
                                                            <Link to="/shop-list" className="dz-media">
                                                                <img src={IMAGES.ProductDress4} alt="/" />
                                                            </Link>
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="col-lg-6">
                                                    <div className="row">
                                                        <div className="col-lg-6 col-md-6 m-sm-b20 m-b30">
                                                            <Link to="/shop" className="about-product-wrapper">
                                                    ...
                                                    <div className="dz-product-media dz-media rounded">
                                                        <img src={IMAGES.ProductDetailStyle1Png1} alt="/" />
                                                    </div>
                                                </div>
                                            </div>
                                        </Tab.Pane>
