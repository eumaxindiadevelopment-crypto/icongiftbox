            ...
            <div className="content-inner py-0 overflow-hidden">
			    ...
			    <div className="container-fluid">
                    ...
                    <div className="banner-social-media">
                        <ul>
                            <li>
                                <Link className="text-dark" to="https://www.instagram.com/dexignzone/">Instagram</Link>
                            </li>
                            <li>
                                <Link className="text-dark" to="https://www.facebook.com/dexignzone">Facebook</Link>
                            </li>
                            <li>
                                <Link className="text-dark" to="https://twitter.com/dexignzones">twitter</Link>
                            </li>
                        </ul>
                    </div>
                </div>
                                ...
                                <div className="dz-content">
                                    ...
                                    <div className="meta-content m-b20 d-flex align-items-end justify-content-between justify-content-sm-start">
                                        <div className="me-5">
                                            ...
                                            <span className="price">{formatPrice(125.75)} <del>{formatPrice(132.17)}</del></span>
                                        </div>
                                    ...
                                    <div className="btn-group cart-btn">
                                        <Link to="/cart" className="btn btn-secondary text-uppercase me-md-4">Add To Cart</Link>
                                    ...
                                    <div className="dz-info style-2">
                                        ...
                                        <ul>
                                            ...
                                            <li><Link to="/shop">Swimwear,</Link></li>
                                            <li><Link to="/shop">Summer,</Link></li>
                                            <li><Link to="/shop">Clothing,</Link></li>
                                        </ul>
                                        <ul>
                                            <li><strong>Tags:</strong></li>
                                            <li><Link to="/shop">Casual,</Link></li>
                                            <li><Link to="/shop">Athletic,</Link></li>
                                            <li><Link to="/shop">Workwear,</Link></li>
