...
export default function ShopFiltersTop(){
    ...
    return(
        <div className="page-content bg-light">
            <CommanBanner currentText="Shop Filters Top" mainText="Shop Filters Top" parentText="Home" image={IMAGES.BackBg1} />
                                ...
                                <div className="filter-wrapper">
                                    ...
                                    <div className="filter-right-area">
                                        <div className="form-group border-0">
                                            <Link to={"#"} className="filter-top-btn" id="filterTopBtn"
                                    ...
                                    <Collapse in={filterContent}>
                                        <div className={`shop-filter mt-xl-2 mt-0 ${filterContent ? "d-block" : ""}`}>
                                            <aside> 
                                                ...
                                                <ShopSidebar buildCategoryHref={(category) => category ? `/shop/category/${category.slug}` : "/shop-filters-top-bar"} />
                                            </aside>
                                        </div>
                                    </Collapse>
                                </div>
