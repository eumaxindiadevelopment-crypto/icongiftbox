...
export default function AccountProfile(){
    ...
    return(
        <div className="page-content bg-light">
            <CommanBanner image={IMAGES.BackBg1} mainText="Profile" parentText="Home" currentText="Account Profile" />
                                    ...
                                    <div className="avatar-upload d-flex align-items-center">
                                        <div className=" position-relative ">
                                            <div className="avatar-preview thumb">
                                                <div id="imagePreview" 
                                                    style={{ backgroundImage: file ? "url(" + URL.createObjectURL(file) + ")" : "url(" + IMAGES.ProfilePic3 + ")" }}
                                                >                                                    
                                                </div>
                                            </div>
