...
export default function AccountCancellationRequests() {
    ...
    return (
        <div className="page-content bg-light">
            <CommanBanner image={IMAGES.BackBg1} mainText="Cancellation Requests" parentText="Home" currentText="Cancellation Requests" />
                        ...
                        <section className="col-xl-9 account-wrapper">
                            <div className="row">
                                ...
                                <div className="col-lg-6">
                                    ...
                                    <Link to="/account-refund-requests-confirmed" className="btn btn-secondary me-xl-3 me-2 btnhover20">Submit Request</Link>
                                </div>
                            </div>
                        </section>
                    </div>
