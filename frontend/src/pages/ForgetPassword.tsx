                            ...
                            <div className="forget-password-area" style={{display : "block"}}>
                                ...
                                <form>
                                    ...
                                    <div className="text-center">
                                        <Link to="/account-dashboard" className="btn btn-secondary btnhover text-uppercase sign-btn">Reset Password</Link>
                                    </div>
                                </form>
                            </div> 
                            :
                            <div className="login-area">
                                ...
                                <form>
                                    ...
                                    <div className="d-flex justify-content-between">
                                        <Link to="/login" className="btn btn-outline-secondary btnhover text-uppercase">Back</Link>
                                        <Link to="#" className="btn btn-secondary btnhover text-uppercase submit-btn form-toggle"
