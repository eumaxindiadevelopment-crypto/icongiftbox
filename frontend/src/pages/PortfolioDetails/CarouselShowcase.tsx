        ...
        <div className="page-content bg-light">
            <section className="pt-0 z-index-unset bg-white overflow-hidden">
                            ...
                            <SwiperSlide key={ind}>
                                <div className="portfolio-box style-2">
                                    ...
                                    <div className="dz-content">
                                        ...
                                        <h4 className="title"><Link to="/portfolio-details-5">{elem.name}</Link></h4>
                                    </div>
                                </div>
                            </SwiperSlide>
                        ))}   
                ...
                <div className="banner-social-media">
                    <ul>
                        <li>
                            <Link className="text-dark" to={"#"}>Instagram</Link>
                        </li>
                        <li>
                            <Link className="text-dark" to={"#"}>Facebook</Link>
                        </li>
                        <li>
                            <Link className="text-dark" to={"#"}>twitter</Link>
                        </li>
                    </ul>
                </div>
            </section>
