                                        ...
                                        <div className="col-md-12">
                                            <div className="month-deal">
                                                <div>
                                                    ...
                                                    <p className="mb-0">Yes! Send me exclusive offers, personalised, and unique gift ideas, tips for shopping on Pixio <Link to="/shop" className="dz-link-2">View All Products</Link></p>
                                                </div>
                                    ...
                                    <ul>
                                        <li>
                                            ...
                                            <div className="dz-content">
                                                <h6 className="name"><Link to="/blogs">Cozy Knit Cardigan Sweater</Link></h6>
                                        ...
                                        <li>
                                            ...
                                            <div className="dz-content">
                                                <h6 className="name"><Link to="/blogs">Sophisticated Swagger Suit</Link></h6>
                                                <span className="time">July 23, 2024</span>
                                            </div>
                                        </li>
                                        <li>
                                            ...
                                            <div className="dz-content">
                                                <h6 className="name"><Link to="/blogs">Athletic Mesh Sports Leggings</Link></h6>
                                                <span className="time">July 23, 2024</span>
                                            </div>
                                        </li>
                                        <li>
                                            ...
                                            <div className="dz-content">
                                                <h6 className="name"><Link to="/blogs">Satin Wrap Party Blouse</Link></h6>
                                                <span className="time">July 23, 2024</span>
                                            </div>
                                        </li>
                                    </ul>
